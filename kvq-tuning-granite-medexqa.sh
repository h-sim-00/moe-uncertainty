...
# --finetune_mode qkv: the existing ./adapters/granite-medexqa was trained with
# Q/K/V LoRA only (no expert LoRA); keep that explicit now that the script's
# default is qkv_experts.
