...
class GraniteMoeConfig(PretrainedConfig):
    ...
    Args:
        ...
        router_mode (`str`, *optional*, defaults to `"top_k"`):
            Router mode for expert selection. Must be one of: `"top_k"`, `"random_k"`, `"fixed_k"`, `"all_equal"`, `"all_weighted"`.
    ...
    def __init__(
        ...
        router_mode="top_k",
        router_temp=1.0, # Only used in `sample_k`
        **kwargs,
    ):
