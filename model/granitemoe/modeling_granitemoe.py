...
# Original Author: IBM and the HuggingFace Inc. team
# Modified by: Albus Li
#
...
class GraniteMoeForCausalLM(GraniteMoePreTrainedModel, GenerationMixin):
    ...
    def change_router_dropout_rate(self, dropout_rate: float = 0.1):
        ...
        for layer in decoder_layers:
            layer.block_sparse_moe.router.dropout = nn.Dropout(dropout_rate)
    ...
    def change_router_mode(self, mode: str="random_k", temp: float = 1.0):
        ...
        for layer in decoder_layers:
            ...
            layer.block_sparse_moe.router_mode = mode
            layer.block_sparse_moe.router_temp = temp
    ...
    def change_router_mode_for_layers(self, mode: str = "random_k", layer_indices=None, temp: float = 1.0):
        ...
        for idx in layer_indices:
            decoder_layers[idx].block_sparse_moe.router_mode = mode
            decoder_layers[idx].block_sparse_moe.router_temp = temp
