#!/bin/bash
#SBATCH --job-name=mfvr-eval
#SBATCH --output=/vol/bitbucket/al1624/FIP/albus-bayesian-moe-router/logs/slurm/slurm_%j_mfvr-eval.log
...
# ====================================================
echo "===================================================="
echo "Starting Task 1: ID Calibration for MFVR"
echo "===================================================="
...
for DATASET_SHORTCODE in "${ID_DATASETS[@]}"; do
    ...
    # Path to the MFVR weights trained on this specific dataset
    RUN_NAME="mfvr-${MODEL_SHORTCODE}-${DATASET_SHORTCODE}"
    ROUTER_WEIGHTS_PATH="./router_weights/mfvr/${RUN_NAME}"
    ...
    for LAYER_SET in "${LAYER_CONFIGS[@]}"; do
        ...
        RESULTS_JSON_PATH="./results/mfvr/id_calib_${RUN_NAME}_layers-${LAYER_FILENAME}.json"
...
# ====================================================
echo "===================================================="
echo "Starting Task 2: OOD Detection for MFVR (ID Model: obqa)"
echo "===================================================="

ID_DATASET_OOD="obqa"
BASE_ADAPTER_PATH="./adapters/${MODEL_SHORTCODE}-${ID_DATASET_OOD}"
RUN_NAME="mfvr-${MODEL_SHORTCODE}-${ID_DATASET_OOD}"
ROUTER_WEIGHTS_PATH="./router_weights/mfvr/${RUN_NAME}"
...
for LAYER_SET in "${LAYER_CONFIGS[@]}"; do
    ...
    LAYER_FILENAME=$(echo "$LAYER_SET" | tr ' ' '-')
    RESULTS_JSON_PATH="./results/mfvr/ood_detect_${RUN_NAME}_layers-${LAYER_FILENAME}.json"
...
echo "All MFVR evaluation tasks completed successfully."
# --- End of Script ---